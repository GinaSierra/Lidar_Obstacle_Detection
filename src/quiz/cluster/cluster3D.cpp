...
int main ()
{
	...
	std::vector<std::vector<float>> points = { {-6.2,7,5}, {-6.3,8.4,5}, {-5.2,7.1,5}, {-5.7,6.3,5}, {7.2,6.1,10}, {8.0,5.3,10}, {7.2,7.1,10}, {0.2,-7.1,-7}, {1.7,-6.9,-7}, {-1.2,-7.2,-7}, {2.2,-8.9,-7} };
    ...
    for (int i=0; i<points.size(); i++) 
  	...
  	std::vector<int> nearby = tree->search({-6,7,5},3.0);
