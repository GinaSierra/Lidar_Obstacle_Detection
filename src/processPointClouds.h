...
#include "quiz/cluster/kdtree3D.h"
...
public:
    ...
    std::vector<typename pcl::PointCloud<PointT>::Ptr> euclideanCluster(typename pcl::PointCloud<PointT>::Ptr cloud, float distanceTol);
